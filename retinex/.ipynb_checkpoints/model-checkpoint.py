...
class lowlight_enhance(object):
    ...
    def test(self, test_low_data=None, test_high_data=None, test_low_data_names=None, save_dir=None, decom_flag=None):
        ...
        print("[*] Testing...")
        print("len of input",(len(test_low_data)))
        for idx in range(len(test_low_data)):
            ...
            print("shape of input",input_low_test.shape)
            ...
            #print(type(R_low), R_low)
            #print(type(R_low), I_low)
            #print(type(R_low), I_delta)
            #print(type(R_low), S)
